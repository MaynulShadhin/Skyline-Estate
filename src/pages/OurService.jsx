...
const OurService = () => {
    return (
        <div className='flex flex-col lg:flex-row items-center m-8 lg:container mx-auto w-full gap-8'>
            <Helmet>
                <meta charSet="utf-8" />
                <title>Our Services-Skyline Estate</title>
            </Helmet>
            <div>
                <img src={service} alt="" />
            </div>
            <div className='m-8'>
                ...
                <div className='flex gap-4 mt-8'>
                    <span className='text-5xl text-lime-500 flex items-center justify-center border-2 border-lime-500 rounded-full w-24 h-14 lg:h-24 hover:bg-lime-500 hover:text-white'><TbHome></TbHome></span>
                    <div>
                ...
                <div className='flex gap-4 mt-8'>
                    <span className='text-5xl text-lime-500 flex items-center justify-center border-2 border-lime-500 rounded-full w-24 h-14 lg:h-24 hover:bg-lime-500 hover:text-white'><VscTools></VscTools></span>
                    <div>
                ...
                <div className='flex gap-4 mt-8'>
                    <span className='text-5xl text-lime-500 flex items-center justify-center border-2 border-lime-500 rounded-full w-24 h-14 lg:h-24 hover:bg-lime-500 hover:text-white'><FaBuilding></FaBuilding></span>
                    <div>
